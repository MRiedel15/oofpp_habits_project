from db import add_habit, check_in_task, edit_habit, delete_habit, load_pre_habit_data, load_pre_tracker_data
...
class Habit:
    ...
    def predefined_data(self, db):
        """
        to load or reset to predefined data
        :param db: an initialized sqlite3 database connection
        :return: data loaded
        """
        load_pre_habit_data(db)
        load_pre_tracker_data(db)
